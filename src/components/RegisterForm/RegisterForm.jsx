...
import { Container, FormContainer, FormName, InputsContainer, FormLabel, FormInput, FormButton } from './RegisterForm-style';
    ...
    registerUser(e) { 
        ...
        fetch('https://webhook.site/3e2f7029-4358-4457-b1c0-0b50e25b71b6', {
            ...
            headers: {
                ...
                'Content-type': 'application/json' // what content type data is sent
            },
